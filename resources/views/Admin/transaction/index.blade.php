                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="row input-daterange ml-2 mt-2">
                                <div class="col-md-4">
                                    <input type="date" name="from_date" id="from_date" value="{{ date('Y-m-d', strtotime('-1 month')) }}" class="form-control"
                                ...
                                <table id="table-data"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama Pengirim</th>
                                            <th>Nama Penerima</th>
                                            <th style="width: 15%">Nomor HP Pengirim</th>
                                            <th>Status</th>
                                            <th>Total Harga</th>
